          ...
          <div class="tab-content">
            ...
            <div class="wizard-footer" style="display:none;">
              <div class="text-center">
                ...
                <a id="menuju-link" href="#"><button type="button" class="btn btn-primary btn-wd">Menuju Tautan</button></a>
              </div>
...
<script>
  $(document).ready(function() {
    ...
    $("#show-qr").click(function(){
      ...
      id_satker = $('#pilih-opd').val();
      id_layanan = $('#pilih-layanan').val();
      var link_qr = "http://192.168.100.239/skm/survey/index/"+id_satker+"/"+id_layanan;
