...
class Operator extends CI_Controller {
	...
	public function ajax_list()
	{
		...
		foreach ($list as $op) {
			...
			//add html for action
			$row[] = '<div class="btn-group"><a class="btn btn-sm btn-warning" href="javascript:void(0)" title="Edit" onclick="edit_('."'".$op->id_user."'".')"><i class="fa fa-edit" ></i></a>
				  <a class="btn btn-sm btn-danger" href="javascript:void(0)" title="Hapus" onclick="delete_('."'".$op->id_user."'".')"><i class="fa fa-trash"></i></div>';
