          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <button class="btn btn-sm btn-success pull-right" onclick="add_()"><i class="fa fa-plus"></i>  Input Manual</button>
                  <div class="table-responsive">
                    <table class="table" id="table" class="table table-striped" style="width: 100%;">
                      <thead class=" text-primary">
                        <th>#</th>
                        <th>Nama OPD</th>
                        <th>Jenis Layanan</th>
                        <th>Penilaian Umum</th>
                        <th>U1</th>
                        <th>U2</th>
                        <th>U3</th>
                        <th>U4</th>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">List Penilaian</h5>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('penilaian/ajax_list')?>",
            "type": "POST"
        },
...
function add_()
{
    ...
    $('.modal-kartu').text('Form Input Manual Survey'); // Set Title to Bootstrap modal title
}
