      ...
      <div class="card">
        ...
        <div class="card-body table-responsive">
          <!-- <div class="table-responsive"> -->
              <!-- <button class="btn btn-sm btn-primary pull-right" onclick="add_()"><i class="fa fa-plus"></i> Operator</button> -->
            <table class="table table-hover" id="table" class="table table-striped" style="width: 100%;">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Responden e-SKM</h5>
            ...
            <div class="modal-footer">
                <button type="button" id="btnSave" onclick="save()" class="btn btn-default">Simpan</button>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('responden/ajax_list')?>",
            "type": "POST"
        },
...
function edit_(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('responden/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('responden/ajax_add')?>";
    } else {
        url = "<?php echo site_url('responden/ajax_update')?>";
    }
...
function delete_(id)
{
    if(confirm('Apakah anda yakin ingin menghapus data ini?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('responden/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
<script type="text/javascript">
$(document).ready(function(){
  $('#showChart').load("<?=base_url('responden/chart_responden');?>");
});
</script>